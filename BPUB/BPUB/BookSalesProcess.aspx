...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-sm-8 form-group">
        ...
        <asp:TextBox CssClass="col-sm-5 form-control" ID="txtPaymentID" runat="server"></asp:TextBox>
    ...
    <div class="col-sm-8 form-group">
        ...
        <asp:DropDownList CssClass="col-sm-5" ID="ddlStudentID" runat="server" DataSourceID="sdsStudentID" DataTextField="Email" DataValueField="StudentID"></asp:DropDownList>
    ...
    <asp:Button CssClass="col-sm-5 btn" ID="btnSubmit" runat="server" Text="Submit" />
